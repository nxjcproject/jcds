<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="table_FormulaWatermeter.aspx.cs" Inherits="AWHReports.Web.UI_StatisticalReport.table_FormulaWatermeter" %>
...
<%--    <script src="../lib/dplib/WdatePicker.js" type="text/javascript" defer="defer" ></script>--%>
    ...
    <script type="text/javascript" src="js/page/table_FormulaWatermeter.js" charset="utf-8"></script>
</head>
               ...
               <div class="easyui-panel" data-options="region:'north',border:true"style="display:normal;height:45px;">   
                  ...
                  <div id="toolbar_formulaDatagrid" style="display: normal;height:35px;">              
                        <table style="padding-left:20px">
                            <tr>      
                                <td style="padding-left:40px; font-size:18px">水 量  消  耗  报  表（<input id="reportTime" class="easyui-textbox" required="required"readonly="readonly" style="width:80px"/>）</td>                                                                               
