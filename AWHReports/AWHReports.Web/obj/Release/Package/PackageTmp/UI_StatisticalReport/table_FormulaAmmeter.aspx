<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="table_FormulaAmmeter.aspx.cs" Inherits="AWHReports.Web.UI_StatisticalReport.table_FormulaAmmeter" %>
...
<%--    <script src="../lib/dplib/WdatePicker.js" type="text/javascript" defer="defer" ></script>--%>
    ...
    <script type="text/javascript" src="js/page/table_FormulaAmmeter.js" charset="utf-8"></script>
</head>
<body onload="researchFun()">
  <div class="easyui-layout" data-options="fit:'true'">
               ...
               <div class="easyui-panel" data-options="region:'north',border:true"style="display:normal;height:45px;">   
                ...
                <div class="easyui-panel" data-options="region:'center', border:true, collapsible:true, split:false">
