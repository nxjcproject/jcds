...
{
    public partial class RealtimeDataMonitorWatermeter : WebStyleBaseForEnergy.webStyleBase
    {
        ...
        public static string GetWaterMeterRealtimeData()
        {
            ...
            DataTable table = WatermeterRealtimeDataService.GetWaterMeterRealtimeDataTable(floorName);
