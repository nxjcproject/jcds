<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WatermeterHistoryData.aspx.cs" Inherits="DataMonitor.Web.UI_HistoryQuery.WatermeterHistoryData" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript" src="js/page/WatermeterHistoryData.js" charset="utf-8"></script>
</head>
<body>
     <div class="easyui-layout" data-options="fit:'true'">
                ...
                <div id="reportTable" class="easyui-panel" data-options="region:'center', border:true, collapsible:true, split:false">
                    <table id="grid_WaterMeterDatagrid" class="easyui-datagrid"></table>
                </div>   
        </div>
</body>
</html>
